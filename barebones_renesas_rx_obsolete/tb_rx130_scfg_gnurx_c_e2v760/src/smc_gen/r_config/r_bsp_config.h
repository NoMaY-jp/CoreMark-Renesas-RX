...
#define BSP_CFG_USER_CHARPUT_FUNCTION     serial_charput
...
*/
#define BSP_CFG_SOSC_DRV_CAP            (1) /* Generated value. Do not edit this manually */
