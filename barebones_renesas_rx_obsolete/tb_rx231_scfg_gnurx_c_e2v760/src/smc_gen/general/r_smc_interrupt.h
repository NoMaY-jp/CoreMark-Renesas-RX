...
#define ICU_CAN_COMFRXINT_PRIORITY                 (_0F_ICU_PRIORITY_LEVEL15)
#define ICU_CAN_RXFINT_PRIORITY                    (_0F_ICU_PRIORITY_LEVEL15)
#define ICU_CAN_TXINT_PRIORITY                     (_0F_ICU_PRIORITY_LEVEL15)
#define ICU_CAN_CHERRINT_PRIORITY                  (_0F_ICU_PRIORITY_LEVEL15)
#define ICU_CAN_GLERRINT_PRIORITY                  (_0F_ICU_PRIORITY_LEVEL15)
...
#define ICU_Security_RD_PRIORITY                   (_0F_ICU_PRIORITY_LEVEL15)
#define ICU_Security_WR_PRIORITY                   (_0F_ICU_PRIORITY_LEVEL15)
#define ICU_Security_Error_PRIORITY                (_0F_ICU_PRIORITY_LEVEL15)
...
#define ICU_SCI0_ERI0_PRIORITY                     (_0F_ICU_PRIORITY_LEVEL15)
#define ICU_SCI0_RXI0_PRIORITY                     (_0F_ICU_PRIORITY_LEVEL15)
#define ICU_SCI0_TXI0_PRIORITY                     (_0F_ICU_PRIORITY_LEVEL15)
#define ICU_SCI0_TEI0_PRIORITY                     (_0F_ICU_PRIORITY_LEVEL15)
