...
__fast_interrupt static void r_Config_SCI1_transmit_interrupt(void)
#else
__interrupt static void r_Config_SCI1_transmit_interrupt(void)
#endif
{
...
__fast_interrupt static void r_Config_SCI1_transmitend_interrupt(void)
#else
__interrupt static void r_Config_SCI1_transmitend_interrupt(void)
#endif
{
    /* Set TXD1 pin */
