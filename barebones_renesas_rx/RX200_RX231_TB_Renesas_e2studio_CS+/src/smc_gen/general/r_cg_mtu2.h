...
/***********************************************************************************************************************
* File Name    : r_cg_mtu2.h
* Version      : 1.1.102
* Device(s)    : R5F52318AxFP
* Description  : General header file for MTU2 peripheral.
***********************************************************************************************************************/
...
#define _04_MTU_PCLK_256                (0x04U) /* Internal clock: counts on PCLK/256 (for MTU3,4) */
#define _05_MTU_PCLK_1024               (0x05U) /* Internal clock: counts on PCLK/1024 (for MTU3,4) */
#define _06_MTU_MTCLKA                  (0x06U) /* External clock: counts on MTCLKA pin input (for MTU3,4) */
#define _07_MTU_MTCLKB                  (0x07U) /* External clock: counts on MTCLKB pin input (for MTU3,4) */
...
*/
/* TCIV4 Interrupt Skipping Link Enable (ITBnVE) (n=4) */
...
/* TGIA3 Interrupt Skipping Link Enable (ITBnAE) (n=3) */
...
/* TCIV4 Interrupt Skipping Link Enable (ITAnVE) (n=4) */
...
/* TGIA3 Interrupt Skipping Link Enable (ITAnAE) (n=3) */
...
/* MTU4.TADCOBRA/B Transfer Timing Select (BF[1:0]) (n=4) */
...
#define _00_MTU_WRE_ENABLE              (0x00U) /* Initial value specified in TOCR is output */
#define _01_MTU_WRE_DISABLE             (0x01U) /* Initial output is inhibited */
